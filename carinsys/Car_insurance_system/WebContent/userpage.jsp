                    ...
                    <div class="col-md-10 ">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6 d-flex justify-content-center align-items-center "
                                ...
                                <a style="color: black" href="prep_add_user_form1.htm">Add User Details</a>

                            </div>
                            
                            <div class="col-md-6 d-flex justify-content-center align-items-center "
                                style="background:rgb(181, 243, 245) ;font-size:30px;font-weight: bold;">
                                <a style="color: black" href="user_list.htm" >User List</a>

                            </div>
                            
                           <a style="color: black" href="home.jsp">Home</a>
