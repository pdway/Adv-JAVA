...
<tr>
	...
	<td>
		<%= exp.getMobNo()%><br>
			...
			<td>
				<a class="btn btn-primary" role="button" aria-pressed="true" href="user_delete.htm?licNo=<%=exp.getLicNo()%>"  >Delete</a><br>
				</td>
		   
			<td>
				<a class="btn btn-primary" role="button" aria-pressed="true" href="user_update_form.htm?licNo=<%=exp.getLicNo()%>" >Update</a><br>
				</td>
 ...
 <a style="color: black" href="userpage.jsp">Back to UserPage</a>
</table>
 </div>       
