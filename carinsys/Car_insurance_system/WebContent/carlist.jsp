...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td>
				<a class="btn btn-primary" role="button" aria-pressed="true" href="car_delete.htm?carNo=<%=exp.getCarNo()%>"  >Delete</a><br>
				</td>
		   
			<td>
				<a class="btn btn-primary" role="button" aria-pressed="true" href="car_update_form.htm?carNo=<%=exp.getCarNo()%>" >Update</a><br>
				</td>
...
<a style="color: black" href="carpage.jsp">Back to CarPage</a>
</table>
 </div>       
